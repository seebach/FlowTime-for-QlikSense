...
require( ["js/qlik"], function ( qlik ) {
    ...
    // var app = qlik.openApp('9afc90d2-e396-4d53-a1dc-3036f6f2feec', config);
      app = qlik.openApp('9afc90d2-e396-4d53-a1dc-3036f6f2feec', config);


    //get objects -- inserted here --
    app.getObject('QV01','gcPJCw');
    app.getObject('QV02','KQUegpv');
    app.getObject('QV03','pJpNmkg');
    app.getObject('QV04','FemtW');
